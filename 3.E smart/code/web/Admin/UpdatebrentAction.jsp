...
//            String vrdate=request.getParameter("vrdate");
            ...
            String vsdesc=request.getParameter("bemail");
           
              
 try{
       Connection con = Db.getConnection();
       Statement st = con.createStatement();
       int j=st.executeUpdate("update brequestrentvehicle set status='Approved' where status='Not_Approved' && vehicleid='"+vehicleid+"' ");
      
       if(j!=0)
       {
          response.sendRedirect("Approvedviewdetails.jsp?var=ResponseSent_Successfully");
       }
       else
       {
           response.sendRedirect("buyviewdetails.jsp?Response Sending Failed");
       }
