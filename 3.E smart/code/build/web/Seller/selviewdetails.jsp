...
<!-- END header -->
            ...
            try
   {
        Connection con = Db.getConnection();
         ...
         String dquery="select * from brequestrentvehicle where bemail ='"+bemail+"' && status='Approved' && payment='pending' ";
       
          ResultSet rs=st.executeQuery(dquery);
       String alldata="";
          while(rs.next())
          {
               alldata=rs.getString(1)+" "+rs.getString(2)+" "+rs.getString(3)+" "+rs.getString(4)+" "+rs.getString(5)+" "+rs.getString(6)+" "+rs.getString(7)+" "+rs.getString(8)+" "+rs.getString(9)+" "+rs.getString(10)+" "+rs.getString(11);
System.out.println(alldata);  
                ...
                <td style="text-align: center"><%=rs.getString(11)%></td>
                 <td style="text-align: center"><a href="rentpayment.jsp?val=<%=alldata%>">Make Payment</a></td>
