...
<!-- END header -->
            ...
            try
   {
        Connection con = Db.getConnection();
         ...
         String dquery="select * from buyvehicle where semail ='"+semail+"' && status='Not_Approved' ";
...
System.out.println(alldata);  
                ...
                <td style="text-align: center"><a href="SResponseAction.jsp?val=<%=alldata%>">Approve</a></td>
            </tr>
          <% 
          }
