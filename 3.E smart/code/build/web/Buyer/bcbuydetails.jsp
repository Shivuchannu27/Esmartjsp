...
<!-- END header -->
    ...
    <%
        ...
        <center><table style="width: 70%;margin-left:10px;margin-right:1px;">
            <tr>
                ...
                <th style="text-align: center">Vehicle Description</th>
            ...
            try
   {
        Connection con = Db.getConnection();
         ...
         String dquery="select * from buyvehicle vehicle where bemail ='"+bemail+"' && status='Approved' && payment='pending' ";
       
          ResultSet rs=st.executeQuery(dquery);
       String alldata="";
          while(rs.next())
          {
               alldata=rs.getString(1)+" "+rs.getString(2)+" "+rs.getString(3)+" "+rs.getString(4)+" "+rs.getString(5)+" "+rs.getString(6)+" "+rs.getString(7)+" "+rs.getString(9);
System.out.println(alldata);  
              ...
              <td style="text-align: center"><%=rs.getString(10)%></td>
                 <td style="text-align: center"><a href="buymakepayment.jsp?val=<%=alldata%>">Make Payment</a></td>
