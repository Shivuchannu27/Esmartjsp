...
<body>
 ...
 <center> <div id="1s"  class="ex1" >
   ...
   <form action="UpdaterentAction.jsp" method="post">
        <%!
        String vehicleid="";
        String aname="";
        String vname="";
       ...
       <div>
        ...
        <input type="text" name="vrdate" value="<%=vrdate%>" />
        </div> 
        ...
        <div>
        <label>Price</label>
        <input type="text" name="vsprice" value="<%=vsprice%>" />
        </div> 
        
        <div>
        <label>Rent From</label>
        <input type="text" name="vrfrom" value="<%=vrfrom%>" />
        </div> 
        
        <div>
        <label>Rent To</label>
        <input type="text" name="vrto" value="<%=vrto%>" />
        </div> 
        
        
        <div>
        <label>Description</label>
        <input type="text" name="vsdesc" value="<%=vsdesc%>" />
        </div> 
