...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
     ...
     <nav class="sidebar sidebar-offcanvas" id="sidebar">
      ...
      <div class="main-panel">
        ...
        <center>  <h1>View Rent Request</h1></center>
        <table id="customers">
            <tr>
                <th>Vehicle ID</th>
                <th> Name</th>
   ...
   String sname=(String)session.getAttribute("c");
         String dquery="select * from srequestrentvehicle where status='not_Approved'; ";
       ...
       String alldata="";
          while(rs.next())
          {
               alldata=rs.getString(1)+" "+rs.getString(2)+" "+rs.getString(3)+" "+rs.getString(4)+" "+rs.getString(5)+" "+rs.getString(6)+" "+rs.getString(7)+" "+rs.getString(8);
                ...
                <td><a href="SUpdatebrent.jsp?val=<%=alldata%>">Approve</a></td>
             </tr>
          <% 
          }
